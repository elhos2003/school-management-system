...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    const homework = JSON.parse(localStorage.getItem("admin_homework") || "[]");
    
    let totalGradesCount = 0;
    students.forEach((student: any) => {
      const studentGrades = localStorage.getItem(`grades_${student.email}`);
      if (studentGrades) {
        const grades = JSON.parse(studentGrades);
    ...
    <div className="dashboard-layout">
      ...
      <main className="main-content">
        ...
        <div className="stats-grid">
          ...
          <div className="stat-card" onClick={() => navigate("/admin/grades")}>
            <div className="stat-icon">📊</div>
            <div className="stat-info">
        ...
        <div className="dashboard-card">
          ...
          <div className="admin-actions">
            ...
            <button className="admin-btn" onClick={() => navigate("/admin/grades")}>📊 Manage Grades</button>
            ...
            <button className="admin-btn" onClick={() => navigate("/admin/behavior")}>🎯 Manage Behavior</button>
            <button className="admin-btn" onClick={() => navigate("/admin/schedule")}>📅 Manage Schedule</button>
          </div>
        </div>
      </main>
    </div>
